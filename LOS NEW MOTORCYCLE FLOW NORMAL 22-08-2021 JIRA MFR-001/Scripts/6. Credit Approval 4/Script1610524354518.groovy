...
WebUI.setText(findTestObject('Komponen_Login/inputusername'), '10620490')
...
WebUI.setText(findTestObject('Credit Approval/Page_New Confins - Main/Notes Approval Action'), 'TEST TRAINING Approval 4')
