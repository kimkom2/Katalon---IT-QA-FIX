...
WebUI.setText(findTestObject('Komponen_Login/inputusername'), '06840516')
...
WebUI.setText(findTestObject('Credit approval 4/Input app credit approval 4'), '601KWA20200800059')
...
WebUI.setText(findTestObject('Credit Approval/Page_New Confins - Main/Notes Approval Action'), 'TEST TRAINING Approval 6')
