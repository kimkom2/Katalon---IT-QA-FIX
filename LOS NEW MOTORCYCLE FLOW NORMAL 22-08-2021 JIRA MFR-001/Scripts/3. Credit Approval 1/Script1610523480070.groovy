...
'ganti sesuai aplikasi yang sudah masuk tahap CRV'
...
WebUI.setText(findTestObject('Credit Approval/Page_New Confins - Main/Notes Approval Action'), 'TEST TRAINING')
