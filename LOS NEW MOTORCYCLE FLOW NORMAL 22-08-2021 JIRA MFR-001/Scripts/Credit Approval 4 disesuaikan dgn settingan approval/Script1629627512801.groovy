...
WebUI.setText(findTestObject('Komponen_Login/inputusername'), '37500914')
...
WebUI.click(findTestObject('Credit Approval 3/Select Apprv 3'))
...
WebUI.click(findTestObject('Credit Approval 3/Menu credit apprv 3'))

'sesuai aplikasi yang sudah masuk tahap CRV'
WebUI.setText(findTestObject('Credit Approval 3/Input app aprv 3'), '601KWA20200800059')
...
WebUI.setText(findTestObject('Credit Approval/Page_New Confins - Main/Notes Approval Action'), 'TEST TRAINING Approval 3')
