...
WebUI.setText(findTestObject('Perbaikan Application Data spliting/Page_New Confins - Main/1 Application Number'), '555APP20210400048')
...
WebUI.setText(findTestObject('Tab Application Data/Input no prospect'), '555APP20210400048', FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.scrollToElement(findTestObject('Tab Application Data/Button Save Continue'), 9)
