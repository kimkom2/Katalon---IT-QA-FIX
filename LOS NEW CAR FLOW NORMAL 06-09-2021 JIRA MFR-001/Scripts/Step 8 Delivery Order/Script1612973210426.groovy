...
WebUI.click(findTestObject('Purchase Order/Select Role'))
...
WebUI.click(findTestObject('Delivery Order/Menu Delivery Order'))

WebUI.delay(3)

'Input no Aplikasi yang akan masuk ke step credit review'
WebUI.setText(findTestObject('Delivery Order/Input Aplikasi No'), '536APP2021010053K')
...
'Update No rangka sesuai sequence'
WebUI.setText(findTestObject('Delivery Order/Input No Rangka'), 'RANGKATEST002')

WebUI.delay(2)

'Update No Mesin sesuai Sequence'
WebUI.setText(findTestObject('Delivery Order/Input No Mesin'), 'MESINTEST002')
