...
WebUI.setText(findTestObject('Form Login/field username'), '12410117')
...
WebUI.click(findTestObject('Credit Approval 2/Select role 12410117'))
...
WebUI.click(findTestObject('Credit Approval 2/Menu Credit Approval'))

WebUI.delay(2)

'Input no Aplikasi yang akan masuk ke step credit review'
WebUI.setText(findTestObject('Credit Approval 2/Input No Aplikasi'), '536APP2021010053K')
...
WebUI.selectOptionByIndex(findTestObject('Credit Approval 2/Select by index Approve 1'), '1', FailureHandling.CONTINUE_ON_FAILURE)

WebUI.selectOptionByValue(findTestObject('Credit Approval 2/Select by value 2'), '2', true)

WebUI.setText(findTestObject('Credit Approval/Input Notes Approval'), 'Notes test', FailureHandling.CONTINUE_ON_FAILURE)

WebUI.delay(2)

WebUI.click(findTestObject('Credit Approval 2/Button Submit'))
