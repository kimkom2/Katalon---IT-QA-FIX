...
WebUI.setText(findTestObject('Menu Invoice/Input No Aplikasi'), '536APP2021010053K')
...
WebUI.setText(findTestObject('Menu Invoice/Input Aplikasi Invoice'), '536APP2021010053K')
...
WebUI.setText(findTestObject('Menu Invoice/Input Invoice Number'), 'INVKWA002')
