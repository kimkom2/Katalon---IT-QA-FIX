...
WebUI.setText(findTestObject('Page_NEW CONFINS LOGIN PAGE/Username'), '06600606')
...
WebUI.click(findTestObject('Page_New Confins - Main/Select ROLE REGIONAL SALES AND DISTRIBUTION HEAD'))
