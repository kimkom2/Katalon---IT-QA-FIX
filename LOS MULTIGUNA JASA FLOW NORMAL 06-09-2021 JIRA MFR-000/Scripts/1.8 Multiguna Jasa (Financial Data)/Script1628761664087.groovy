...
WebUI.click(findTestObject('Perbaikan Financial data/Page_New Confins - Main/a_Financial Data'))
...
WebUI.doubleClick(findTestObject('Page_New Confins - Main/Input Rate Friday Financial Data'))

WebUI.delay(2)

WebUI.sendKeys(findTestObject('Page_New Confins - Main/Input Rate Friday Financial Data'), '50', FailureHandling.STOP_ON_FAILURE)
