...
WebUI.click(findTestObject('Admin verification/1 Admin Verification'))

WebUI.delay(2)

WebUI.setText(findTestObject('Admin verification/2 input_Application No'), '599APP20210300014')

WebUI.click(findTestObject('Admin verification/3 hbtnSearch'))

WebUI.delay(2)

WebUI.click(findTestObject('Admin verification/4 action'))

WebUI.delay(2)

WebUI.click(findTestObject('Admin verification/a_Submit'))
