...
WebUI.click(findTestObject('invoice verification/3 Invoice Verification'))

WebUI.delay(2)

WebUI.setText(findTestObject('invoice verification/4 input_Application Number'), '599APP20210300014')

WebUI.click(findTestObject('invoice verification/5 btnSearch'))

WebUI.delay(2)

WebUI.click(findTestObject('invoice verification/6 action'))

WebUI.delay(2)

WebUI.click(findTestObject('invoice verification/7 Verif'))

WebUI.setText(findTestObject('invoice verification/8 notes'), 'oke')

WebUI.delay(2)

WebUI.setText(findTestObject('invoice verification/9 Verif Date'), '03/03/2021')

WebUI.delay(2)

WebUI.click(findTestObject('invoice verification/10 Submit'))
