...
WebUI.setText(findTestObject('1 Add Mou Factoring/1 NRK'), '34720119')
...
WebUI.click(findTestObject('3 MOU APPROVAL/1 Role'))
...
WebUI.scrollToElement(findTestObject('3 MOU APPROVAL/a_MOU Factoring'), 10)

WebUI.doubleClick(findTestObject('3 MOU APPROVAL/a_MOU Factoring'))

WebUI.delay(2)

WebUI.click(findTestObject('3 MOU APPROVAL/2 MOU Approval'))
...
WebUI.selectOptionByIndex(findTestObject('3 MOU APPROVAL/5 Task'), '1', FailureHandling.CONTINUE_ON_FAILURE)
