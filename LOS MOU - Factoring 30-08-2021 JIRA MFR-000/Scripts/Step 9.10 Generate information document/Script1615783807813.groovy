...
WebUI.click(findTestObject('Generate information document/1 Generate Confirmation Document'))

WebUI.delay(2)

WebUI.setText(findTestObject('Generate information document/2 Application no'), '599APP20210300014')

WebUI.click(findTestObject('Generate information document/3 btnSearch'))

WebUI.delay(2)

WebUI.click(findTestObject('Generate information document/4 action'))

WebUI.delay(2)

WebUI.click(findTestObject('Generate information document/5 Financial Data'))

WebUI.delay(2)

WebUI.click(findTestObject('Generate information document/6 Submit'))
