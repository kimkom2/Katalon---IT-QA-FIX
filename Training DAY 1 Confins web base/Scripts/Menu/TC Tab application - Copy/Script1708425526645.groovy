...
//WebUI.selectOptionByValue(findTestObject('Menu/Credit admin/Page_New Confins - Main/List Insallment scheme'), 'RF', true)
...
//WebUI.click(findTestObject('Menu/Credit admin/Page_New Confins - Main/List Marketing Officer'))
//
//WebUI.delay(1)
//
//WebUI.selectOptionByValue(findTestObject('Menu/Credit admin/Page_New Confins - Main/List Marketing Officer'), '53809', true)
//
